 ...
 * v.1.b - changed the value for times
 */
...
unsigned long time_to_stop = 90;  // 200; 
unsigned long blink_speed; // [ms] smaller number is faster blinking
unsigned long fade_delay = 5; //2; // [ms] smaller number is faster fade

int brightness = 0;    // how bright the LED is
int fadeAmount = 3;   // 1; rr // how many points to fade the LED by
